...
!function ($) {
    ...
    * ==================== */
    ...
    Table.prototype = {
        ...
        this.activate($this, $type, $title, $content, $root);
  }

  , activate: function (element, type, title, content, root, callback) {
      ...
      function open() {
          ...
          if (type === "modal") {
              ...
              if ($(element).hasClass("table-toggle")) {
                  ...
                  var cols = $(element).find("td").length;
                  var tr = "<tr><td colspan='" + cols + "'><audio src='" + content + "'></td></tr>";
                  $(element).addClass("table-toggle");
                  $(tr).insertAfter(element);
              }
    ...
    * ============ */
    ...
    $(function () {
        $('body').on('click.table.data-api', '[data-type="modal"], [data-type="inline"], [data-type="inline-audio"], [data-url="*"], [data-root="*"], [data-content="*"]', function (e) {
            e.preventDefault();
            $(this).table('show')
        })
    })
